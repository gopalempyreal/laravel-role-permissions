...
class PermissionServiceProvider extends ServiceProvider
{
    ...
    {
        $bladeMethodWrapper = '\\Empyrealinfotech\\Permission\\PermissionServiceProvider::bladeMethodWrapper';
    ...
    protected function registerAbout(): void
    {
        ...
        AboutCommand::add('Empyrealinfotech Permissions', static fn () => [
            'Features Enabled' => collect($features)
                ...
                ->join(', '),
            'Version' => InstalledVersions::getPrettyVersion('Empyrealinfotech/laravel-permission'),
        ]);
    }
}
