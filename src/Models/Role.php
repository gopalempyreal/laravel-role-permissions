...
namespace Empyrealinfotech\Permission\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Empyrealinfotech\Permission\Contracts\Role as RoleContract;
use Empyrealinfotech\Permission\Exceptions\GuardDoesNotMatch;
use Empyrealinfotech\Permission\Exceptions\PermissionDoesNotExist;
use Empyrealinfotech\Permission\Exceptions\RoleAlreadyExists;
use Empyrealinfotech\Permission\Exceptions\RoleDoesNotExist;
use Empyrealinfotech\Permission\Guard;
use Empyrealinfotech\Permission\PermissionRegistrar;
use Empyrealinfotech\Permission\Traits\HasPermissions;
use Empyrealinfotech\Permission\Traits\RefreshesPermissionCache;
...
class Role extends Model implements RoleContract
{
     ...
     *
     * @param  string|int|\Empyrealinfotech\Permission\Contracts\Permission|\BackedEnum  $permission
     *
