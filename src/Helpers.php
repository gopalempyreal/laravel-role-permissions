...
if (! function_exists('setPermissionsTeamId')) {
    ...
    {
        app(\Empyrealinfotech\Permission\PermissionRegistrar::class)->setPermissionsTeamId($id);
    }
}
...
if (! function_exists('getPermissionsTeamId')) {
    ...
    {
        return app(\Empyrealinfotech\Permission\PermissionRegistrar::class)->getPermissionsTeamId();
    }
}
